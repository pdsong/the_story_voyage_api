defmodule TheStoryVoyageApi.Application do
  ...
  def start(_type, _args) do
    children = [
      TheStoryVoyageApiWeb.Telemetry,
      ...
      TheStoryVoyageApiWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: TheStoryVoyageApi.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    TheStoryVoyageApiWeb.Endpoint.config_change(changed, removed)
    :ok
  end
